...
<%-- 
			1번 방법 
			<li class="page-item"><a class="page-link" href="/board?page=${pram.page +1}">Next</a></li> 
			2번 방법
			<li class="page-item disabled"><a class="page-link" href="${boardsEntity.number-1}">Prev</a></li>
			센세가 추천한 방법
			--%>
